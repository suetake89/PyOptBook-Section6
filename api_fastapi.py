...
```
# パワーシェルではなくコマンドプロンプトで以下を実行
# curl -X POST -H "accept: application/json" -H "Content-Type: application/json" -d "@resource/request_fastapi.json" http://127.0.0.1:8000/api
"""
#!pip install fastapi
import pandas as pd
